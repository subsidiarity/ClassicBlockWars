...
public class PingCloudRegions : MonoBehaviour
{
	...
	{
		ServerSettings settings2 = (ServerSettings)Resources.Load("PhotonServerSettings", typeof(ServerSettings));
		if (settings2.HostType == ServerSettings.HostingOption.OfflineMode)
		{
			yield break;
		}
		ClosestRegion = null;
